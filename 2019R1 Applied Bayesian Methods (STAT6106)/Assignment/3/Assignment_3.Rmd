...
#plot3d(randu3k);
```
![regularity of pseudorandom numbers.](Screen Shot 2019-11-02 at 14.41.01.png)
...
```
* The Pearson correlation between IMSL and SIMSCRIPT is `r correlation`.
\newpage
...
```
* The integrals approximations are: `r integral`.
<br />
